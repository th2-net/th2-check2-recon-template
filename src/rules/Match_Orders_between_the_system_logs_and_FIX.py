...
class Rule(rule.Rule):
    ...
    def get_name(self) -> str:
        ...
        name = "NewOrderSingle FIX vs Logs: "
        for group in groups:
            aliases = list()
    ...
    def get_description(self) -> str:
        return "NewOrderSingle messages written to the logs and NewOrderSingle messages received by FIX protocol are " \
               "the same "
    ...
    def hash(self, message: ReconMessage, attributes: tuple, *args, **kwargs):
        ...
        val = ''
        for field_name in ['ClOrdID', 'SecurityID']:
    ...
    def check(self, messages: [ReconMessage], *args, **kwargs) -> Event:
        ...
        ignore_fields = ['CheckSum', 'BodyLength', 'SendingTime']
