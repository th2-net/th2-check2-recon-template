...
setup(
    ...
    url='https://gitlab.exactpro.com/vivarium/th2/th2-core-open-source/th2-check2-recon-template',
    license='Apache License 2.0',
    python_requires='>=3.7',
    install_requires=[
        get_dependency(dependency_name='th2-check2-recon', dependency_version='2.1.2')
    ],
    packages=[''] + find_packages(include=['th2_check2_recon_template', 'th2_check2_recon_template.*']),
